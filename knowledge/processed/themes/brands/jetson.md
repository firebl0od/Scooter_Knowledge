...
- Haku still refuses to run field weakening after killing multiple stock hubs at ~4 A—he limits the Jetson to 20 S commuter duty with hydraulic brakes and monitors stator temps closely on long errands.[^1]
...
- Avoid burnout demos that lock the rear wheel—seasoned builders note controller deaths usually follow abusive front-wheel burnouts, not regular commuting.[^2]
