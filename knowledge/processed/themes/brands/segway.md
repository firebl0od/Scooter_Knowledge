...
[^gt_shock]: Segway GT rotor/suspension packaging constraints—Hope V4 calipers, rotor spacing, shock clearance, and chassis stability once dialed in.【F:knowledge/notes/input_part003_review.md†L177-L186】
[^gt_teardown]: GT teardown detailing the 14 S 12 P Lishen pack, single-MCU 24‑FET controller, 10 AWG phase leads, and adjustable suspension hardware that make the chassis a solid VESC swap candidate.【F:data/vesc_help_group/text_slices/input_part003.txt†L23023-L23090】
[^gt_packaging]: Кирилл’s GT build uses a 22 S8 P P42A pack with a 400 A ANT BMS, QS10 leads, dual motor NTCs, and 155 mm×3.1 mm rotors under Hope V4 calipers; the trailing arm limits rotors to ≈140 mm unless you fabricate custom brackets or weld new mounts.【F:data/vesc_help_group/text_slices/input_part003.txt†L24802-L25463】
