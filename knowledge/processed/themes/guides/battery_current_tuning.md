...
3. **Log, ride, iterate**
   ...
   - Watch battery sag and motor temps; race scooters typically drop 4–8 V on 22 S pulls and consider double-digit sag a warning, while heavy 20 S commuters logging 10–13 V dips at 200 A per controller only stay healthy because cooling and pack temps are tracked closely.¹⁰ ²⁷
   ...
   - Treat VESC Tool’s state-of-charge gauge as informational at best unless you pair it with Vedder’s BMS; the percentage routinely lies, so rely on live pack voltage when lowering cutoffs toward 3 V per cell even after you account for its 4.2–3.3 V interpolation.²⁵ ²⁸
4. **Layer in regen**
