...
- **Premium compound trade-offs:** PMT E-Fire 10×3 radials land around $175 per pair shipped from Italy, while PMT Stradales can feel skittish on Weped frames where softer Shinko rubber hooks up better.
  - budget tire swaps accordingly.[^5]
...
- **PMT casings play nice either way.** They arrive tubeless-ready yet tolerate inner tubes (even CST 10×2.5) and the stiff carcass can limp home deflated long enough to reach a workshop.[^28]
- **Document split-rim wear.** Repeated pothole strikes ovalize rim halves.
  - swap components and log tire experiments until wobble disappears, keeping spare halves and bearings ready for field service.[^29]
- **Service speed counts.** VSETT split rims separate quickly once axle nuts are off, letting techs swap tires or tubes trackside.
  - some rental hubs even bundle drum brakes with the split rims to streamline AWD conversions.[^30]
- Inflate new casings to full pressure to seat beads evenly, then bleed down to your ride PSI.
...
- **Blast stubborn tubeless beads.** For 11 in conversions, remove the valve core, flood the bead with soapy water, cinch the tread, and dump ~150 psi from a bead bazooka or large compressor.
  - portable inflators lack the airflow. Immediately bleed pressure back toward 50 psi for riding once the bead pops.[^36]
- **Skip improvised “air cannons.”** Ratchet straps and steady 5.5 bar airflow work; pulsed compressors and homemade blasts have flung hoses, damaged hearing, and convinced riders to buy shop-grade 8 bar compressors instead.[^37]
- **Pick aluminum-safe sealants.** Yellow tubeless Slime avoids rim corrosion and plays nicely with PMT/Xuancheng setups; mixing CRC Fix foam with standard Slime violently reacts and coats the wheel in expanding goo.[^38][^39]
- **Tubeless conversions on stock casings leak without upkeep.** When PMT stock dries up, riders retrofit OEM tires with tubeless valves and automotive sealant, but the rims seep unless the sealant is refreshed regularly.
  - plan a maintenance schedule if you go this route.[^40]
- **Rinse tube sealant after seating.** Tube-specific Slime must be flushed from tubeless G30 rims once the bead seals to prevent long-term corrosion and mess inside the wheel.[^41]
- **Use the valves provided with modern tubeless casings.** PMT/Xuancheng tires now ship with tubeless valves that seal without slime.
  - reserve sealant for aluminum-safe formulas if you still want puncture insurance.[^42]
- **Heat and reshape dented rims cautiously.** Small tubeless rim dents can be warmed and hammered flat, but expect to reseal with silicone or swap the tire if the bead still leaks after repairs.
...
- **Protect Monorim hub screws.** When swapping to pneumatics, support the wheel and ease out the five perimeter screws.
  - stripping one ruins the hub. Drill for 90° valves, shield magnets from filings, and rotate the stem ~45° if it still touches the fork.[^monorim-valve]
- **Budget deck extenders for big packs.** Xiaomi Pro 2 builders squeeze 20 S 4 P bricks with extenders while 15 S 4 P remains the fallback.
  - mixed internal/external packs must balance stem weight before chasing 20 S 9 P ambitions.[^54]
- **Stock decks still fit big bricks.** Pulling the honeycomb inserts lets the Pro 2 swallow 12 S 8 P (~96 cells) and even dual QS8 leads, but plan tight 6 AWG bends carefully to avoid rubbing through insulation inside the tunnel.[^55]
...
- **Pair 500 W Monorim hubs with quality air tires.** The workshop cautioned that the 500 W kit feels unsafe on stock rubber.
  - install a modded air tire before feeding it 12 S power so traction matches the torque jump.[^56]
- **Plan frame swaps around rim spacing.** Builders eyeing dual 72 V projects are already stockpiling stiffer Chinese frames, DT2 EX donor shells, and Vsett or Blade swingarms once they secure matching forks and brake adapters for the wider axles.[^57]
- **Respect stem limits before chasing 16 S dual motors.** Veterans warn that stock M365 stems snap when you push dual drives without full chassis reinforcement, dual brakes, suspension, and deck plates.
  - costs that rival a Vsett 9/9+ with safer geometry.[^58]
- **Budget pack volume realistically.** You can squeeze 13 S 6 P into the deck if the controller moves outside, but AWD conversions usually need backpack or rack batteries plus AWG6 cabling, eroding Xiaomi’s portability advantage.[^59]
- **Consider Ninebot frames for big builds.** Builders chasing stealth still love the Xiaomi Pro, yet Ninebot G30 chassis package dual VESCs and large packs more gracefully once stealth is less critical.[^60]
- **Source race-proven tubeless hardware.** Rage Mechanics and RFP rims lock beads under race abuse.
  - document part numbers plus the matching Amass 8 mm connectors so others can replicate the setup without guessing at components.[^61]
- **Respect 17 S upgrade limits.** A 17 S6 P Samsung 40T build demanded dual XT150 phase connectors, meticulous insulation, and tolerance for ~20 V droop through an undersized Daly BMS.
  - plan thicker leads, fresh brakes, and be aware regen on over-voltage packs can spike controllers until the hardware is upgraded.[^62]
- **Charging workarounds matter.** Riders lived with 16 S chargers dialled to ~67 V until programmable supplies arrived, watching pack balance closely because Daly boards refuse to equalise below ~4.18 V per cell on these over-voltage Xiaomi builds.[^63]
- **Transplanting G30 hubs.** Reversing the Monorim fork and extending phase leads lets Xiaomi frames host Ninebot G30 hubs.
  - pair them with stout ESCs and 20 S 9 P packs to chase 100 km/h potential.[^64]
...
- **Controller mounting templates:** Community drills for hanging a Ubox 75 V 100 A under the deck rely on threaded inserts plus separate buck converters for 5 V tail lights.
  - document hole spacing and enclosure choices before copying the layout.[^70]
- **Budget alternatives:** Properly adjusted MTB-style mechanical calipers (“Bike Attitude”) can outperform misaligned semi-hydraulics when combined with 135 mm rotors.
  - center the fixed pad before tightening mounts.[^66]
- **SNSC drum adapters:** Inverted SNSC setups need a spacer and both mounting points engaged before the drum aligns.
  - plan fabrication time instead of relying on a single bracket.[^71]
- **Kotto 3 mm motorcycle calipers:** Expect to machine spacers and bleed them immediately.
...
- **Don’t delete the front brake.** Dual-motor Xiaomi 1S conversions that rely on rear regen plus a single disc are unsafe at speed.
  - budget a second hydraulic front brake once you add the extra hub.[^76]
- **Torque lever bleeds properly.** Magura lever bleed screws only want 0.5 Nm; overtightening strips the threads and dumps pressure mid-ride.[^77]
...
- **Lighting integration:** 3D-printed fender supports and extender housings can host sealed LED strips, wireless turn-signal pods, Lumos Matrix helmet mounts, or DIY 12 V strobes.
  - just route wiring inside the bag to protect it from tire splash.[^88][^89]
- **Beam pattern validation:** Budget Towwoo “8000 lm” lights produced narrow hotspots compared with Olight/OSRAM lamps.
  - photograph beam patterns after upgrades so Xiaomi riders can trust claimed lumen figures.[^90]

## Monitoring & Instrumentation

- **Bluetooth temperature logging:** Coin-cell-powered Bluetooth probes provide live pack and ESC temperature data when stress-testing high-power builds.[^91]

## Lighting & Visibility Upgrades

- **Mount signals at eye level:** Helmet or backpack-mounted indicators remain visible in daylight, unlike low fender kits that sit below most drivers’ sightlines.[^92]
- **Harden rear-light wiring:** Reroute the harness, pot exposed joints, hot-glue the tail-light connector after 10" conversions, and add reflective tape or low-profile sticker kits to boost conspicuity without bulky add-ons.[^93][^94]

## Range & Accessory Add-ons

- **Pack for long rides:** Dual 12 S packs tied through multi-pack Rita adapters, anti-spark links, or backpack enclosures can stretch range toward 80 km while keeping total mass around 6 kg.[^95]
...
2. **Bed brakes:** After any pad or rotor swap, bed the system in with controlled stops to prevent glazing and squeal.
  - especially important for semi-metallic upgrades.[^66]
3. **Retorque hardware:** Recheck axle nuts, adapter bolts, and suspension pivots after the first rides; stretched wheelbases and taller tires settle hardware quickly.[^66][^8]
...
[^1]: Source: knowledge/notes/all_part01_review.md†L226-L228
[^2]: Source: knowledge/notes/all_part01_review.md†L369-L370
[^3]: Source: knowledge/notes/all_part01_review.md†L696-L696
[^4]: Source: knowledge/notes/input_part001_review.md†L55-L55
...
[^16]: Source: knowledge/notes/denis_all_part02_review.md†L99284-L99353
[^17]: Source: data/vesc_help_group/text_slices/input_part007.txt†L494-L515
[^18]: Source: data/vesc_help_group/text_slices/input_part007.txt†L543-L547
[^19]: Source: knowledge/notes/denis_all_part02_review.md†L99361-L99375
[^20]: Source: knowledge/notes/denis_all_part02_review.md†L99715-L99733
[^21]: Source: knowledge/notes/all_part01_review.md†L381-L381
[^22]: Source: knowledge/notes/all_part01_review.md†L447-L447
[^23]: Source: knowledge/notes/all_part01_review.md†L186-L186
[^24]: Source: data/vesc_help_group/text_slices/input_part003.txt†L12150-L12156
[^25]: Source: data/vesc_help_group/text_slices/input_part003.txt†L12214-L12226
[^26]: Source: knowledge/notes/input_part006_review.md†L259-L259
[^27]: Source: knowledge/notes/denis_all_part02_review.md†L418-L418
[^28]: Source: knowledge/notes/input_part001_review.md†L60-L60
[^29]: Source: knowledge/notes/input_part001_review.md†L61-L61
[^30]: Source: knowledge/notes/input_part001_review.md†L62-L62
[^31]: Source: knowledge/notes/input_part005_review.md†L131-L131
[^32]: Source: knowledge/notes/input_part005_review.md†L134-L134
[^33]: Source: knowledge/notes/denis_all_part02_review.md†L90621-L90637
[^34]: Source: knowledge/notes/denis_all_part02_review.md†L90909-L90921
[^35]: Source: knowledge/notes/denis_all_part02_review.md†L81739-L81819
[^36]: Source: knowledge/notes/input_part005_review.md†L202-L204
[^37]: Source: knowledge/notes/input_part005_review.md†L357-L358
[^38]: Source: knowledge/notes/denis_all_part02_review.md†L85974-L85997
[^39]: Source: knowledge/notes/denis_all_part02_review.md†L81862-L81882
[^40]: Source: knowledge/notes/denis_all_part02_review.md†L449-L449
[^41]: Source: knowledge/notes/input_part005_review.md†L356-L357
[^42]: Source: knowledge/notes/denis_all_part02_review.md†L101765-L101775
