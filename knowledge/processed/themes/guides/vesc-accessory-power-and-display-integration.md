...
1. **Order matters on dual-rail harnesses.** Feeding 5 V into a Flipsky Smart Display before the 12 V lead repeatedly destroyed Spintend ADC daughterboards; always energise 12 V first, then 5 V, and confirm the display ground is shared with the controller. Spinny/ADC daughterboards powered from auxiliary bucks also demand that the external 12 V rail comes alive before you wake the controller.【F:knowledge/notes/input_part013_review.md†L366-L367】【F:knowledge/notes/input_part013_review.md†L796-L796】
...
5. **Use the accessory hub to keep OEM switches.** The Spintend ADC3 bridge exposes extra horn/indicator inputs so Ninebot G2 conversions can retain factory controls while migrating to VESC hardware.【F:data/vesc_help_group/text_slices/input_part013.txt†L10337-L10346】
...
4. Document NFC-based immobiliser options for Spintend controllers so riders chasing keyless locks (e.g., Rogerio’s build) have vetted modules and wiring diagrams.【F:knowledge/notes/input_part013_review.md†L723-L723】
