...
- **12″ conversions squeeze everything.** PuneDir’s 12″ front swap highlighted limited motor-to-spring clearance, while Paolo noted that true 11″ hubs often strike suspension hardware unless spacers are reworked—measure before ordering big-wheel conversions.【F:data/vesc_help_group/text_slices/input_part009.txt†L6281-L6299】【F:data/vesc_help_group/text_slices/input_part009.txt†L6369-L6371】
- **Check drivetrain assumptions.** Some regions still deliver Zero 10X as a single-motor scooter with a dummy front hub—budget for a second powered wheel, harness, and controller instead of assuming dual-drive out of the box.【F:data/vesc_help_group/text_slices/input_part009.txt†L20600-L20610】
- **Plan fork spacing for 11″ hubs.** Paolo’s conversions needed roughly 145 mm between dropouts plus longer axles to seat 11″ 70 H motors; stock 125 mm forks top out around 65 H hubs unless you extend the swingarm or buy a kit such as FalconPEV’s.【F:data/vesc_help_group/text_slices/input_part009.txt†L21169-L21180】【F:data/vesc_help_group/text_slices/input_part009.txt†L21339-L21348】
- **Budget bespoke frames for 100 km/h builds.** Riders chasing 100–105 km/h package electronics “French style” inside custom housings, often relocating controllers externally and leaning on ~22 S 11 P packs that approach 9 kW—expect expensive fabrication as the tradeoff for stability at that speed.【F:data/vesc_help_group/text_slices/input_part009.txt†L21728-L21744】
- **FalconPEV swingarms extend 11″ builds.** Their kit gives the fork and rear end the extra length 11″ hubs need, but riders still reinforce the steering assembly to curb cracking once longer arms and high-power motors go on.【F:data/vesc_help_group/text_slices/input_part009.txt†L21642-L21663】【F:data/vesc_help_group/text_slices/input_part009.txt†L21754-L21755】
- **Run dual brakes at highway speed.** Riders running 100 km/h pulls on rear-only Nutt calipers and regen keep getting warned—reinstate the front hydraulic brake before more highway tuning sessions.【F:data/vesc_help_group/text_slices/input_part009.txt†L21194-L21218】
