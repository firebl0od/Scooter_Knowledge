...
- **Zero-FW still has a cost.** Dropping FW to zero saved energy but forced higher phase current for the same speed, driving controller temps from 46 °C to 55 °C in just 15 minutes—log thermal response whenever you reshuffle FW allocations.【F:knowledge/notes/input_part012_review.md†L151-L151】
...
- **Tame 6.06 sensorless chatter with zero-vector tweaks.** Riders on firmware 6.06 are logging smoother sensorless handoffs once they nudge zero-vector frequency and duty timing alongside FW ramps, so add those adjustments to any vibration-troubleshooting checklist before blaming hardware.【F:knowledge/notes/input_part012_review.md†L301-L301】
...
- **Mind saturation and hall health.** A Halo 60H stuttered at 15–20 km/h when pushed to 350 A phase with 125 A FW; adding temperature sensing, trimming phase amps, and keeping saturation compensation around 10–15 % prevented false diagnoses of phase shorts.【F:knowledge/notes/input_part012_review.md†L152-L152】
- **Log saturation-comp targets when chasing 300 A+.** The current review segment calls for documenting how much saturation compensation riders add as they balance 300 A phase and aggressive FW—keep the tuning notes with your high-power profiles so teammates don’t reuse stale values on fresh hardware.【F:knowledge/notes/input_part012_review.md†L302-L302】
- **Observer & ABS interplay:** Mxlemming observers with ~125 A FW demanded higher ABS headroom (~420 A) to stop overcurrent faults at 300 A phase, while milder 30 A FW still tripped ABS on sticky launches—log ABS thresholds anytime you swap observers.【F:knowledge/notes/input_part012_review.md†L63-L63】
- **Mixed pole-count drivetrains:** Pairing a 40-pole front with a 30-pole rear confuses traction control; racers often disable TC and preload the bars instead, relying on rider weight to settle launches.【F:knowledge/notes/input_part012_review.md†L64-L64】
