...
- **Water-cooling option:** Matthew’s custom water-cooled base plate on a 100/100 drops FET temps from ~54 °C back to ~40 °C within a minute during 35 °C ambient pulls at 130 A phase—proof that external radiators can rescue commuters stuck with minimal deck airflow.【F:knowledge/notes/input_part013_review.md†L390-L392】
...
- **Preserve bulk capacitance when downsizing.** Deck-limited MKS 84200HP installs still need ≥2,800 µF on the DC link—catalog compact capacitor options and mounting strategies before trimming the bank just to make the enclosure fit.【F:knowledge/notes/input_part013_review.md†L104-L104】
