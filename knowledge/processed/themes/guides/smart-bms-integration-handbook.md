...
| **ANT Smart** | 200 A (70 mm-wide) to 240 A/600 A surge boards | Compact footprint, app-based current ramp controls, simultaneous cell balancing, proven on Weped FS builds and 20 s 7 p side-mounted packs plus the new 10–32 S/220 A SKU for 20 S scooters.[^3][^12][^13][^ant-32s] | Regen kills controllers if charge FETs stay disabled; app pairing quirks persist, discharge toggles can trip Tronic stages, larger units stay awake above ~61 V, and one 470 A/1050 A board latched its discharge FETs after charging—plan redundant pack protection and be ready for full resets with component inspection if the load never opens.[^4][^14][^ant-floor][^ant-latch] |
...
- **Capture ANT latch failures.** The 470 A/1050 A ANT smart BMS has latched discharge FETs even after toggling charge/discharge outputs, leaving scooters energized overnight—budget redundant pack protection, plan full power-down resets, and inspect for burnt components before trusting the board again.[^ant-latch]
