...
- Stuffing 72 cells into a 3 L Wildman bag technically works only if you fold copper interconnects and skip cell holders—veterans still call holderless bricks unacceptable for long-term reliability.[^wildman-72]
...
- Xiaomi-class decks need every millimetre: Gabe is printing a 5.4 cm extender to stack a 20 s pack under dual ESCs, and his “fastest Pro 2” split the 20 s7 p pack across twin 5 L shoulder bags because the 10.5–11 cm deck leaves only 0.3–0.5 cm spare width.【F:knowledge/notes/input_part007_review.md†L218-L219】

[^wildman-72]: Packing 72 cells into a 3 L Wildman bag requires folded copper and no holders—veterans still reject holderless bricks as unreliable.【F:data/vesc_help_group/text_slices/input_part007.txt†L236-L239】
[^blade-layouts]: Blade conversions are juggling 20 s 8 p “clean” packs, 20 s 4 p MH1 beaters, and alternative 16 s 5 p / 13 s 6 p layouts to manage sag when 21700s won’t fit the frame.【F:data/vesc_help_group/text_slices/input_part007.txt†L252-L263】
[^blade-voltage]: A single 10 s Blade motor already wheelies—plan 72 V controllers and packs before going dual motor so torque stays controllable.【F:data/vesc_help_group/text_slices/input_part007.txt†L241-L247】
[^72v-3p5kw]: Happy Giraffe reminded the group that 48 A at 72 V is ~3.5 kW—raise voltage and lean on ~100 A phase instead of stuffing more battery amps into MH1 cells.【F:data/vesc_help_group/text_slices/input_part007.txt†L273-L277】
...
- **P45B for brute force.** Choose Molicel P45B when the build needs 400 A+ bursts and minimal voltage sag; Happy Giraffe’s cell curves show it beating Samsung 50S at 30 A while running cooler than P42A/40T, justifying the premium when range and punch matter.【F:knowledge/notes/input_part005_review.md†L605-L605】【F:knowledge/notes/input_part007_review.md†L229-L229】
...
| Layer epoxy sheet, plexiglass, fishpaper, and polycarbonate around frame-mounted packs so vibration and water cannot chafe nickel or balance leads once the battery doubles as a chassis member.【F:knowledge/notes/input_part007_review.md†L315-L321】 | Stage multi-layer insulation wherever packs bolt to frames or sit near sharp edges. | Prevents fretting failures on high-voltage deck builds. |
| Copper under nickel survives pull tests; pure copper strips still pop free—tune weld energy to ≈40 J on nickel, 60–70 J on copper, and sandwich layers so joints tear metal instead of lifting.【F:knowledge/notes/input_part007_review.md†L321-L325】 | Weld copper-nickel sandwiches in one pass and proof the nugget with pull tests. | Produces durable high-current busbars without bulky nickel stacks. |
| Tape between nickel layers, triple shrink with silicone-sealed exits, and route balance leads through plexiglass channels to protect 20 S harnesses from wet-deck chafing.【F:knowledge/notes/input_part007_review.md†L325-L329】 | Overbuild insulation wherever 20 S looms exit tight decks. | Keeps high-series harnesses from abrading through on commuters. |
| Active-balancing hardware only shuttles ~600 mA between groups—confirm the gain before reordering hardware or count on passive boards that simply dump excess energy as heat.【F:knowledge/notes/input_part007_review.md†L329-L334】 | Pick balancers based on real current instead of marketing numbers. | Prevents disappointment with pricey “active” hardware. |
| Stop routine charges around 90 % if the BMS still balances there—commuters quadruple pack life by avoiding full charges.【F:knowledge/notes/input_part007_review.md†L334-L336】 | Set chargers and rider habits for partial charges when longevity outranks maximum range. | Extends cycle life on daily-use packs. |
| Salvaged Dyson V8 modules hide 6 S 1 P Molicels; release the enclosure’s hidden pins, refresh welds, and be ready to reflash the smart BMS with a Pickit 3 to clear soft-locks.【F:knowledge/notes/input_part007_review.md†L336-L349】【F:knowledge/notes/input_part007_review.md†L349-L353】 | Treat vacuum modules as quality donor cells once electronics are reset. | Adds an affordable path to high-discharge cells for scooter packs. |
| Samsung 50E chemistries polarise builders—four-year Weped FS packs still hit 240 A with low sag, yet many reserve the cells for huge parallel counts while relying on 40T/P42A for high-amp builds.【F:knowledge/notes/input_part007_review.md†L353-L356】 | Size 50E packs for high parallel count or pick punchier chemistry when current demand is high. | Matches chemistry to the mission to avoid premature sag. |
...
[^holder-clamp]: Threaded rods, dots of superglue, and even duct tape keep PETG holders aligned until final wraps; clear packing tape is the last resort when Kapton runs out.【F:knowledge/notes/input_part007_review.md†L217-L224】
...
- **0.15 mm pure nickel still works—within limits.** Mirono signs off on 0.15 mm strip in a W-bridge layout for ~40 A scooter packs provided per-cell current stays under the strip’s rating, sparing builders from copper busbars on moderate loads.【F:knowledge/notes/input_part007_review.md†L223-L223】
