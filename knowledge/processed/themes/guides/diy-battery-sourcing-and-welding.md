...
- **Heat busbars evenly when soldering.** MP2 busbar assemblies warp if one side sees more torch time than the other—keep heat balanced so the copper/aluminium stack stays flat before tightening it onto cells.【F:knowledge/notes/input_part006_review.md†L56-L57】
...
- **Verify “nickel” strip claims.** Builders caught steel masquerading as nickel; test with magnets or order precut busbars/stacked pure nickel when chasing 5 kW targets without switching to copper.【F:knowledge/notes/input_part006_review.md†L65-L65】
...
- **Map 3 L Wildman limits.** External add-ons top out around 56×21700 cells; hybrid layouts split parallels (e.g., 12 P internal, 8 P bag) and require careful nickel planning before committing to the enclosure.【F:knowledge/notes/input_part006_review.md†L64-L64】
